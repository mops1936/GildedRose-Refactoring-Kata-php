...
```sh
git clone git@github.com:mops1936/GildedRose-Refactoring-Kata-php.git
```

or

```shell script
git clone https://github.com/mops1936/GildedRose-Refactoring-Kata-php.git
```
...
PHPUnit is configured for testing, a composer script has been provided. To run the unit tests, from the root of the project run:
